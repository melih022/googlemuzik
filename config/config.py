...
BOT_TOKEN = getenv("BOT_TOKEN", "8431999361:AAHyc531MlXYioVSSq3-KIontgyFG7W7qTw")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001977465611"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/melih022/googlemuzik",
)
